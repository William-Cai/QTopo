...
export const initEvents = (iposs) => {
    ...
    iposs.events = {
        ...
        TopoEvent_ADD_GROUP(position, element, properties) {
            windows("addGroup", {
                position: position
            });
        },
        ...
        TopoEvent_GROUP_EXPANDED_TOGGLE(position, element, properties) {
            if (_.isGroup(element) && _.isFunction(element.toggle)) {
                element.toggle();
            }
        },

        TopoEvent_LINK_EXPANDED_TOGGLE(position, element, properties) {
            if (_.isLink(element) && _.isFunction(element.toggle)) {
                element.toggle();
            }
        },

        TopoEvent_OUT_GROUP(position, element, properties) {
